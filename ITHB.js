function showInputEText(){
document.getElementById("inputEText").style.display = "block";
}
function showInputMText(){
document.getElementById("inputMText").style.display = "block";
}
